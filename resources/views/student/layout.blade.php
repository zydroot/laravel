...
<head>
    ...
    <style>
        .header {
            height: 100px; margin: 0 auto 20px; background: #f5f5f5; }
        .main { width: 1000px; height: 200px; margin: 0 auto; }
        ...
        .footer { width:1000px; height:100px;margin:0 auto;  margin-top: 15px; background: #f5f5f5;
